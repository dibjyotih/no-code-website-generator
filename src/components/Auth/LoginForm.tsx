...
export const LoginForm: React.FC<LoginFormProps> = ({ onLoginSuccess, onSwitchToRegister, onGuestMode }) => {
      ...
      <div className="auth-form-card">
        ...
        {showDbWarning && (
          <div className="db-warning">
            ...
            <p>User accounts are currently unavailable.</p>
            <button onClick={onGuestMode} className="guest-mode-btn">
              Continue as Guest
            </button>
          </div>
        )}
